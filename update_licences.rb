...
OptionParser.new do |opts|
    opts.banner = "Usage: update_licences.rb [options]"
            ...
            if(value_header)
                ...
                if(property_value.to_s.length()>0)
                    begin 
                        ...
                        puts "Could not update property " + property_name + " for Licence: " + lic_id
                    end
                end
            end
            #Now set notes
            ...
            if(notes_header)
                ...
                if(property_note.to_s.length()>0)
                    begin
                        ...
                        puts "Could not update note for " + property_name + " for Licence: " + lic_id
                    end
                end
            end
        end
        puts "Updated Licence: " + lic_id
    end
end
